...
static void testSLAEncodeDecode_EncodeDecodeTest(void *obj)
{
  ...
  static const struct EncodeDecodeTestCase test_case[] = {
    /* 無音の部 */
    { { 1,  8, 0,  0 },
      { 4, 1, 4, SLA_CHPROCESSMETHOD_NONE, SLA_WINDOWFUNCTIONTYPE_SIN, 16384 },
      8192,
    ...
    { { 1, 24,  0, 16 },
      ...
      testSLAEncodeDecode_GenerateSilence },
    { { 2,  8,  0,  0 },
      { 4, 1, 4, SLA_CHPROCESSMETHOD_STEREO_MS, SLA_WINDOWFUNCTIONTYPE_SIN, 16384 },
      8192,
      testSLAEncodeDecode_GenerateSilence },
    { { 2, 16,  0,  0 },
      { 4, 1, 4, SLA_CHPROCESSMETHOD_STEREO_MS, SLA_WINDOWFUNCTIONTYPE_SIN, 16384 },
...
static void testSLAEncodeDecode_EncodeStreamingDecodeTest(void *obj)
{
  ...
  static const struct EncodeDecodeTestCase test_case[] = {
    /* 無音の部 */
    { { 1,  8,  44100,  0 },
      { 4, 1, 4, SLA_CHPROCESSMETHOD_NONE, SLA_WINDOWFUNCTIONTYPE_SIN, 8192 },
      32768,
      testSLAEncodeDecode_GenerateSilence },
    { { 1, 16,  48000,  0 },
      { 4, 1, 4, SLA_CHPROCESSMETHOD_NONE, SLA_WINDOWFUNCTIONTYPE_SIN, 8192 },
    ...
    { { 1, 24, 192000,  0 },
      ...
      testSLAEncodeDecode_GenerateSilence },
    { { 2,  8,  44100,  0 },
      { 4, 1, 4, SLA_CHPROCESSMETHOD_STEREO_MS, SLA_WINDOWFUNCTIONTYPE_SIN, 8192 },
      32768,
      testSLAEncodeDecode_GenerateSilence },
    { { 2, 16,  48000,  0 },
      { 4, 1, 4, SLA_CHPROCESSMETHOD_STEREO_MS, SLA_WINDOWFUNCTIONTYPE_SIN, 8192 },
